...
#     full_output=True
# )
# # print("Agent LLM type:", type(Agent_LLM))
# result = crew.kickoff()

# if Customer_Query_catergorize.output.expected_output == 'order_tracking':
#     print(Track_Orders.output.exported_output)
# elif Customer_Query_catergorize.output.expected_output == 'returns_request':
#     print(Track_Returns.output.exported_output)
# elif Customer_Query_catergorize.output.expected_output == 'prod_recommendations':
